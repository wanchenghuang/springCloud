...
public class AuthenticationServiceImpl implements IAuthenticationService {
    ...
    public boolean decide(HttpServletRequest authRequest) {
        ...
        //获取此访问用户所有角色拥有的权限资源
        Set<ResourcePo> userResources = findResourcesByUsername(authentication.getName());
     ...
     * @return
     */
    public boolean isMatch(ConfigAttribute urlConfigAttribute, Set<ResourcePo> userResources) {
     ...
     * @return
     */
    private Set<ResourcePo> findResourcesByUsername(String username) {
        //用户被授予的角色资源
        Set<ResourcePo> resources = resourceService.queryByUsername(username);
